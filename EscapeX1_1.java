    ...
    public static void Jogar() {
        ...
        do {
            ...
            case 3:
				...
				case "caixa:
				case "Caixa":
					System.out.println("A caixa está trancada. Você pode utilizar um grampo para abri-la ou resolver uma equação de 2º grau. Digite uma das opções: "
							+ "1. Usar grampo \n"
				...
				case "Porta":
					...
					if (grampos >= 5) || (chaveG >= 1){
						System.out.println("Porta aberta! Você está livre");
						comodo = 6;
						break;						
